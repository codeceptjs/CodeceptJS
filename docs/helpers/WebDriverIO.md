...
-   `option`  Appium: support only web testing
...
-   `cookie`  Appium: support only web testingUses Selenium's JSON [cookie format](https://code.google.com/p/selenium/wiki/JsonWireProtocol#Cookie_JSON_Object).
