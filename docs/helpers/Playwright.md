...
-   `show` **[boolean][29]?** show browser window.
-   `restart` **([string][8] | [boolean][29])?** restart strategy between tests. Possible values:-   'context' or **false** - restarts [browser context][36] but keeps running browser. Recommended by Playwright team to keep tests isolated.
    -   'browser' or **true** - closes browser and opens it again between tests.
    -   'session' or 'keep' - keeps browser context and session, but cleans up cookies and localStorage between tests. The fastest option when running tests in windowed mode. Works with `keepCookies` and `keepBrowserState` options. This behavior was default before CodeceptJS 3.1
-   `timeout` **[number][13]?** -   [timeout][37] in ms of all Playwright actions .
-   `disableScreenshots` **[boolean][29]?** don't save screenshot on failure.
-   `emulate` **any?** browser in device emulation mode.
-   `video` **[boolean][29]?** enables video recording for failed tests; videos are saved into `output/videos` folder
-   `keepVideoForPassedTests` **[boolean][29]?** save videos for passed tests; videos are saved into `output/videos` folder
-   `trace` **[boolean][29]?** record [tracing information][38] with screenshots and snapshots.
-   `keepTraceForPassedTests` **[boolean][29]?** save trace for passed tests.
-   `fullPageScreenshots` **[boolean][29]?** make full page screenshots on failure.
...
-   `keepBrowserState` **[boolean][29]?** keep browser state between tests when `restart` is set to 'session'.
-   `keepCookies` **[boolean][29]?** keep cookies between tests when `restart` is set to 'session'.
-   `waitForAction` **[number][13]?** how long to wait after click, doubleClick or PressKey actions in ms. Default: 100.
-   `waitForNavigation` **(`"load"` | `"domcontentloaded"` | `"networkidle"`)?** When to consider navigation succeeded. Possible options: `load`, `domcontentloaded`, `networkidle`. Choose one of those options is possible. See [Playwright API][39].
-   `pressKeyDelay` **[number][13]?** Delay between key presses in ms. Used when calling Playwrights page.type(...) in fillField/appendField
-   `getPageTimeout` **[number][13]?** config option to set maximum navigation time in milliseconds.
-   `waitForTimeout` **[number][13]?** default wait* timeout in ms. Default: 1000.
...
-   `manualStart` **[boolean][29]?** do not start browser before a test, start it manually inside a helper with `this.helpers["Playwright"]._startBrowser()`.
...
-   `channel` **any?** (While Playwright can operate against the stock Google Chrome and Microsoft Edge browsers available on the machine. In particular, current Playwright version will support Stable and Beta channels of these browsers. See [Google Chrome & Microsoft Edge][40].
-   `ignoreLog` **[Array][18]&lt;[string][8]>?** An array with console message types that are not logged to debug log. Default value is `['warning', 'log']`. E.g. you can set `[]` to log all messages. See all possible [values][41].
-   `ignoreHTTPSErrors` **[boolean][29]?** Allows access to untrustworthy pages, e.g. to a page with an expired certificate. Default value is `false`
-   `bypassCSP` **[boolean][29]?** bypass Content Security Policy or CSP
...
-   `destElement` **([string][8] | [object][5])** located by CSS|XPath|strict locator.
    ⚠️ returns a _promise_ which is synchronized internally by recorder```js
...
-   `offsetX` **[number][13]** position to drag.
    ⚠️ returns a _promise_ which is synchronized internally by recorder 
...
-   `fn` **([string][8] | [function][14])** function to be executed in browser context.
-   `arg` **any?** optional argument to pass to the function

Returns **[Promise][15]&lt;any>** 
...
Returns **[Promise][15]&lt;[string][8]>** attribute value
...
Returns **[Promise][15]&lt;[Array][18]&lt;[string][8]>>** attribute value
...
[Learn more about console messages][19]

Returns **[Promise][15]&lt;[Array][18]&lt;any>>** 
...
Returns **([Promise][15]&lt;[string][8]> | [Promise][15]&lt;[Array][18]&lt;[string][8]>>)** attribute valueReturns cookie in JSON format. If name not passed returns all cookies for this domain.
...
Returns **[Promise][15]&lt;[string][8]>** CSS value
...
Returns **[Promise][15]&lt;[Array][18]&lt;[string][8]>>** CSS value
...
Returns **[Promise][15]&lt;[string][8]>** current URL
...
Returns **[Promise][15]&lt;any>** automatically synchronized promise through #recorder
...
Returns **([Promise][15]&lt;DOMRect> | [Promise][15]&lt;[number][13]>)** Element bounding rectangle
...
Returns **[Promise][15]&lt;[string][8]>** HTML code for an element
...
Returns **[Promise][15]&lt;[Array][18]&lt;[string][8]>>** HTML code for an element
...
Returns **[Promise][15]&lt;[number][13]>** number of open tabs
...
Returns **[Promise][15]&lt;[number][13]>** number of visible elements
...
Returns **[Promise][15]&lt;PageScrollPosition>** scroll position
...
Returns **[Promise][15]&lt;([string][8] | null)>** 
...
Returns **[Promise][15]&lt;[string][8]>** source code
...
Returns **[Promise][15]&lt;[string][8]>** title
...
Returns **[Promise][15]&lt;[object][5]>** response
...
-   `url` **([string][8] | [RegExp][24])?** URL, regex or pattern for to match URL
-   `handler` **[function][14]?** a function to process reques
...
-   `locator` **([string][8] | [object][5])** located by CSS|XPath|strict locator.
-   `offsetX` **[number][13]** (optional, `0` by default) X-axis offset. 
-   `offsetY` **[number][13]** (optional, `0` by default) Y-axis offset.
    ⚠️ returns a _promise_ which is synchronized internally by recorder 
...
-   `key` **([string][8] | [Array][18]&lt;[string][8]>)** key or array of keys to press.
    ⚠️ returns a _promise_ which is synchronized internally by recorder_Note:_ Shortcuts like `'Meta'` + `'A'` do not work on macOS ([GoogleChrome/Puppeteer#1313][27]).
...
-   `width` **[number][13]** width in pixels or `maximize`.
-   `height` **[number][13]** height in pixels.
...
-   `locator` **([string][8] | [object][5])** element located by CSS|XPath|strict locator.
-   `num` **[number][13]** number of elements.
    ⚠️ returns a _promise_ which is synchronized internally by recorder
...
-   `option` **([string][8] | [Array][18]&lt;any>)** visible text or value of option.
    ⚠️ returns a _promise_ which is synchronized internally by recorder
...
-   `cookie` **(Cookie | [Array][18]&lt;Cookie>)** a cookie object or array of cookie objects.
    ⚠️ returns a _promise_ which is synchronized internally by recorder
...
-   `keys`  
-   `delay` **[number][13]?** (optional) delay in ms between key presses
    ⚠️ returns a _promise_ which is synchronized internally by recorder 
-   `key` **([string][8] | [Array][18]&lt;[string][8]>)** or array of keys to type.
...
-   `field` **([string][8] | [object][5])** checkbox located by label | name | CSS | XPath | strict locator.
-   `context` **([string][8]? | [object][5])** (optional, `null` by default) element located by CSS | XPath | strict locator.
    ⚠️ returns a _promise_ which is synchronized internally by recorder[Additional options][30] for uncheck available as 3rd argument.Examples:```js
    // click on element at position
...
-   `fn` **[function][14]** async function that executed with Playwright helper as argumen
...
-   `sec` **[number][13]** number of second to wait.
    ⚠️ returns a _promise_ which is synchronized internally by recorder
...
-   `locator` **([string][8] | [object][5])** element located by CSS|XPath|strict locator.
-   `waitTimeout`  
-   `sec` **[number][13]?** (optional, `1` by default) time in seconds to wait
    ⚠️ returns a _promise_ which is synchronized internally by recorder
...
-   `locator` **([string][8] | [object][5])** element located by CSS|XPath|strict locator.
-   `sec` **[number][13]** (optional) time in seconds to wait, 1 by default.
    ⚠️ returns a _promise_ which is synchronized internally by recorder 
...
-   `fn` **([string][8] | [function][14])** to be executed in browser context.
-   `argsOrSec` **([Array][18]&lt;any> | [number][13])?** (optional, `1` by default) arguments for function or seconds. 
-   `sec` **[number][13]?** (optional, `1` by default) time in seconds to wait
    ⚠️ returns a _promise_ which is synchronized internally by recorder 
...
-   `urlOrPredicate` **([string][8] | [function][14])** 
-   `sec` **[number][13]?** seconds to wait 
...
-   `urlOrPredicate` **([string][8] | [function][14])** 
-   `sec` **[number][13]?** number of seconds to wait 
...
-   `locator` **([string][8] | [object][5])** element located by CSS|XPath|strict locator.
-   `sec` **[number][13]** (optional, `1` by default) time in seconds to wait
    ⚠️ returns a _promise_ which is synchronized internally by recorderThis method accepts [React selectors][35]. 
...
[16]: https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/focus

[17]: https://playwright.dev/docs/api/class-locator#locator-focus

[18]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array

[19]: https://playwright.dev/docs/api/class-consolemessage
...
[37]: https://playwright.dev/docs/api/class-page#page-set-default-timeout

[38]: https://playwright.dev/docs/trace-viewer

[39]: https://playwright.dev/docs/api/class-page#page-wait-for-navigation

[40]: https://playwright.dev/docs/browsers/#google-chrome--microsoft-edge

[41]: https://playwright.dev/docs/api/class-consolemessage#console-message-type
