...
*   `keepAlive` **[number][10]?** session keep-alive time in milliseconds
...
*   `capabilities` **[object][7]?** pre-configured capabilities; Kitesurf uses { layout: 'real', screenshot: true }
