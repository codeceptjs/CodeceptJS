...
Returns **[Promise][7]<[boolean][8]>** Appium: support only Android
...
Returns **[Promise][7]<void>** Appium: support both Android and iOS
...
Returns **[Promise][7]<[Array][9]<[string][5]>>** Appium: support Android and iOS
...
Returns **[Promise][7]<[string][5]>** attribute value
...
Returns **[Promise][7]<[Array][9]<[string][5]>>** attribute value
...
Returns **[Promise][7]<([string][5] | null)>** Appium: support Android and iOS
...
Returns **[Promise][7]<[string][5]>** Appium: support only Android
...
Returns **[Promise][7]<{}>** Appium: support only Android
...
Returns **[Promise][7]<[number][10]>** number of visible elements
...
Returns **[Promise][7]<[string][5]>** Appium: support Android and iOS
...
Returns **[Promise][7]<void>** Appium: support only Android
...
Returns **[Promise][7]<void>** Appium: support Android and iOS
...
Returns **[Promise][7]<void>** Appium: support only iOS
...
- `locator` **([string][5] | [object][6])** located by CSS|XPath|strict locator.
- `scrollIntoViewOptions` **(ScrollIntoViewOptions | [boolean][8])** either alignToTop=true|false or scrollIntoViewOptions. See [https://developer.mozilla.org/en-US/docs/Web/API/Element/scrollIntoView][13].
...
- `option` **([string][5] | [Array][9]<any>)** visible text or value of option.
...
List of keys: [https://developer.android.com/reference/android/view/KeyEvent.html][14]
...
- `xoffset` **[number][10]**&#x20;
- `yoffset` **[number][10]**&#x20;
- `speed` **[number][10]** (optional), 1000 by default
...
- `actions` **[Array][9]** Array of touch actions
...
[14]: https://developer.android.com/reference/android/view/KeyEvent.html
[15]: http://webdriver.io/api/mobile/setImmediateValue.html
[16]: https://webdriver.io/docs/api/chromium/#setnetworkconnection
[17]: http://webdriver.io/api/mobile/swipe.html
