...
> ⚠️ This plugin was moved to its [own package][4]
...
-   `enableScreenshotDiffPlugin` - a boolean flag for add screenshot diff to report.
     ...
     See [Allure Screenshot Plugin][6]
...
-   `opts` **[Object][20]** Options for the test case (optional, default `{}`)
...
[Selenoid][21] plugin automatically starts browsers and video recording.
...
> If you have issues starting Selenoid with this plugin consider using the official [Configuration Manager][22] tool from Selenoid
...
When `autoCreate` is enabled it will pull the [latest Selenoid from DockerHub][23] and start Selenoid automatically.
...
> Use [Selenoid Configuration Manager][22] to create and start containers semi-automatically.

1.  Create `browsers.json` file in the same directory `codecept.conf.js` is located
    [Refer to Selenoid documentation][24] to know more about browsers.json.
...
Run the following command to create a container. To know more [refer here][25]
...
| additionalParams | example: `additionalParams: '--env TEST=test'` [Refer here][26] to know more   |
...
A complete list of all available services can be found on [webdriverio website][28].
...
Install `@wdio/selenium-standalone-service` package, as [described here][29].
...
Install `@wdio/sauce-service` package, as [described here][30].
It is important to make sure it is compatible with current webdriverio version.
...
[4]: https://github.com/codeceptjs/allure-plugin

[5]: https://user-images.githubusercontent.com/220264/45676511-8e052800-bb3a-11e8-8cbb-db5f73de2add.png

[6]: https://github.com/allure-framework/allure2/blob/master/plugins/screen-diff-plugin/README.md

[7]: https://user-images.githubusercontent.com/63167966/139339384-e6e70a62-3638-406d-a224-f32473071428.png

[8]: https://user-images.githubusercontent.com/63167966/215404458-9a325668-819e-4289-9b42-5807c49ebddb.png

[9]: https://user-images.githubusercontent.com/63167966/215404645-73b09da0-9e6d-4352-a123-80c22f7014cd.png
...
[21]: https://aerokube.com/selenoid/

[22]: https://aerokube.com/cm/latest/

[23]: https://hub.docker.com/u/selenoid

[24]: https://aerokube.com/selenoid/latest/#_prepare_configuration

[25]: https://aerokube.com/selenoid/latest/#_option_2_start_selenoid_container

[26]: https://docs.docker.com/engine/reference/commandline/create/

[27]: https://codecept.io/img/codeceptjs-slideshow.gif

[28]: https://webdriver.io

[29]: https://webdriver.io/docs/selenium-standalone-service.html

[30]: https://webdriver.io/docs/sauce-service.html
