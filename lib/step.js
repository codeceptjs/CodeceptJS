...
class MetaStep extends Step {
  ...
  /** @return {boolean} */
  isBDD() {
    if (this.actor && this.actor.match(/^(Given|When|Then|And)/)) {
      return true;
    }
    return false;
  }
  ...
  isWithin() {
    if (this.actor && this.actor.match(/^(Within)/)) {
      return true;
    }
    return false;
  }
  ...
  run(fn) {
    ...
    // @TODO: need right handle
    const result = fn.apply(this.context, this.args);
