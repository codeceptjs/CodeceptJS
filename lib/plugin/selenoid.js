 ...
 *
 * > If you have issues starting Selenoid with this plugin consider using official [Configuration Manager](https://aerokube.com/cm/latest/) tool from Selenoid
 *
 * ### Usage
 *
...
const pullImage = async () => {
  ...
  output.print('Pulling in Selenoid containers. This may take a while...');
  ...
  return Promise.all(pulls).then(() => {
    ...
    output.debug('Disable `autoCreate` in Selenoid plugin and pull in all containers manually to reduce this time');
  });
};
