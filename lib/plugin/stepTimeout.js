...
module.exports = (config) => {
  ...
  // below override rule makes sure customTimeoutSteps go first but then they overridden with noTimeoutSteps in case of exact pattern match
  ...
  event.dispatcher.on(event.step.before, (step) => {
    ...
    if (step.totalTimeout === undefined || config.force) {
