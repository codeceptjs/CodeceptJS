 ...
 * Allure reporter
 *
 * > ⚠️ This plugin was moved to its [own package](https://github.com/codeceptjs/allure-plugin)
 *
...
module.exports = (config) => {
  console.log('DEPRECATION WARNING: Allure plugin was moved to @codeceptjs/allure-plugin. Please install it and update your config');
  console.log();
  ...
  console.log('}');
  console.log();
  console.log('This plugin won\'t receive updates and will be removed in CodeceptJS 3.5');
