 ...
 * ```js
 *  "executors": {
 *    "enable": true, // Enable collect executor info
 *    "gitlab": {
 *      "enable": true, // Enable collect Gitlab info
 *      "url": 'https://gitlab-rnd.tcsbank.ru',
 *      "reportUrl": `https://${process.env.CI_PROJECT_NAME}-${process.env.CI_COMMIT_REF_SLUG}-reports.gke-qa.pfpdev.ru`,
...
function getGitlabExecutorInfo(param) {
  const defaultParam = {
    ...
    reportUrl: param.reportUrl || '',
    reportName: param.reportName || 'Allure Report',
  };
