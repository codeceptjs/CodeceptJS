...
class REST extends Helper {
   ...
   */
  async sendGetRequest(url, headers = {}, proxy = false) {
    const request = {
   ...
   * @param {object} headers
   */
  async sendPostRequest(url, payload = {}, headers = {}, proxy = false) {
    const request = {
      baseURL: this._url(url),
      method: 'POST',
      data: payload,
   ...
   * @param {object} headers
   */
  async sendPatchRequest(url, payload, headers = {}, proxy = false) {
    const request = {
      baseURL: this._url(url),
      method: 'PATCH',
      data: payload,
   ...
   * @param {object} headers
   */
  async sendPutRequest(url, payload = {}, headers = {}, proxy = false) {
    const request = {
      baseURL: this._url(url),
      method: 'PUT',
      data: payload,
   ...
   * @param {object} headers
   */
  async sendDeleteRequest(url, headers = {}, proxy = false) {
    const request = {
      baseURL: this._url(url),
      method: 'DELETE',
      headers,
