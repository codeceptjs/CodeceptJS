...
class Puppeteer extends Helper {
  ...
  _handleDisconnection() {
    throw new Error('Connection with remote browser was lost.');
  }
  ...
  async _startBrowser() {
    if (this.isRemoteBrowser) {
      ...
      this.browser.on('disconnected', this._handleDisconnection);
  ...
  async _stopBrowser() {
    ...
    popupStore.clear();
    if (this.isRemoteBrowser) {
      this.browser.off('disconnected', this._handleDisconnection);
