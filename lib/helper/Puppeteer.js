 ...
 * * `detectOS`: (optional, default: false) - replace `Meta` <=> `Control` keys based on current OS.
...
function getNormalizedKey(key) {
  const normalizedKey = getNormalizedKeyAttributeValue(key, this.options.detectOS);
