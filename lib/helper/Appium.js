...
class Appium extends WebdriverIO {
  ...
  _validateConfig(config) {
    ...
    platform = this.options.desiredCapabilities.platformName.toLowerCase();
  ...
  appendField(field, value) {
    return super.appendField(withStrictLocator(field), value);
  }
  ...
  checkOption(checkbox) {
    return super.checkOption(withStrictLocator(checkbox));
  }
  ...
  click(button, context) {
    return super.click(withStrictLocator(button), withStrictLocator(context));
  }
  ...
  dontSeeCheckboxIsChecked(checkbox) {
    return super.dontSeeCheckboxIsChecked(withStrictLocator(checkbox));
  }
  ...
  dontSeeElement(el, context) {
    return super.dontSeeElement(withStrictLocator(el));
  }
  ...
  dontSeeInField(field, value) {
    return super.dontSeeInField(withStrictLocator(field), value);
  }
  ...
  dontSee(text, context) {
    return super.dontSee(text, withStrictLocator(context));
  }
  ...
  fillField(field, value) {
    return super.fillField(withStrictLocator(field), value);
  }
   ...
   */
  grabTextFrom(el) {
    return super.grabTextFrom(withStrictLocator(el));
  }
   ...
   */
  grabValueFrom(el) {
    return super.grabValueFrom(withStrictLocator(el));
  }
  ...
  seeCheckboxIsChecked(checkbox) {
    return super.seeCheckboxIsChecked(withStrictLocator(checkbox));
  }
   ...
   */
  seeElement(el) {
    return super.seeElement(withStrictLocator(el));
  }
   ...
   */
  seeInField() {
    return super.seeInField(withStrictLocator(field), value);
  }
   ...
   */
  see(text, context) {
    return super.see(text, withStrictLocator(context));
  }
  ...
  selectOption(select, option) {
    return super.selectOption(withStrictLocator(select), option);
  }
...
function withStrictLocator(locator) {
  ...
  if (typeof locator === 'string') {
    ...
    if (locator[0] == '#') return withStrictLocator({ id: locator.slice(1) });
    if (platform == 'android') {
  ...
  if (locator.android && platform == 'android') {
    return withStrictLocator(locator.android);
  }

  if (locator.ios && platform == 'ios') {
    return withStrictLocator(locator.ios);
  }
  ...
  case 'id':
    if (!browserCap && platform == 'android') {
