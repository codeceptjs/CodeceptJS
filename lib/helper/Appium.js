...
class Appium extends WebdriverIO {
  ...
  async _startBrowser() {
    if (this.options.multiremote) {
      this.browser = await webdriverio.multiremote(this.options.multiremote).init();
    } else {
      this.browser = await webdriverio.remote(this.options).init();
    }
    this.isRunning = true;
    let promisesList = [];
    ...
    if (this.options.windowSize === 'maximize' && !this.platform) {
      let res = await this.browser.execute('return [screen.width, screen.height]');
...
<<<<<<< HEAD
  seeAppIsInstalled(bundleId) {
    ...
    return this.browser.isAppInstalled(bundleId).then(res => truth(`app ${bundleId}`, 'to be installed').assert(res.value));
=======
  async seeAppIsInstalled(bundleId) {
    onlyForApps.call(this, "Android");
    let res = await this.browser.isAppInstalled(bundleId);
...
<<<<<<< HEAD
  seeAppIsNotInstalled(bundleId) {
    onlyForApps.call(this, 'Android');
    return this.browser.isAppInstalled(bundleId).then(res => truth(`app ${bundleId}`, 'to be installed').negate(res.value));
=======
...
<<<<<<< HEAD
  seeCurrentActivityIs(currentActivity) {
    onlyForApps.call(this, 'Android');
    return this.browser.currentActivity().then(res => truth('current activity', `to be ${currentActivity}`).assert(res.value === currentActivity));
=======
  async seeCurrentActivityIs(currentActivity) {
    onlyForApps.call(this, "Android");
    let res = await this.browser.currentActivity();
...
<<<<<<< HEAD
  seeDeviceIsLocked() {
    onlyForApps.call(this, 'Android');
    return this.browser.isLocked().then(res => truth('device', 'to be locked').assert(res.value));
=======
  async seeDeviceIsLocked() {
    onlyForApps.call(this, "Android");
    let res = await this.browser.isLocked()
...
<<<<<<< HEAD
  seeDeviceIsUnlocked() {
    onlyForApps.call(this, 'Android');
    return this.browser.isLocked().then(res => truth('device', 'to be locked').negate(res.value));
=======
...
<<<<<<< HEAD
    return this.browser.orientation().then(res => truth('orientation', `to be ${orientation}`).assert(res.value === orientation));
=======
    let res = await this.browser.orientation();
...
>>>>>>> refactored
  ...
  async grabAllContexts() {
    onlyForApps.call(this);
<<<<<<< HEAD
    return this.browser.contexts().then(res => res.value);
=======
    let res = await this.browser.contexts();
    return res.value;
>>>>>>> refactored
  }
  ...
  async grabContext() {
    onlyForApps.call(this);
<<<<<<< HEAD
    return this.browser.context().then(res => res.value);
=======
    let res = await this.browser.context();
    return res.value;
>>>>>>> refactored
  }
...
<<<<<<< HEAD
  grabNetworkConnection() {
    onlyForApps.call(this, 'Android');
    return this.browser.getNetworkConnection().then(res => ({
      value: res.value,
...
=======
  async grabNetworkConnection() {
    onlyForApps.call(this, "Android");
    let res = await this.browser.getNetworkConnection();
    return {
      value: res.value,
      inAirplaneMode: res.inAirplaneMode,
      hasWifi: res.hasWifi,
...
>>>>>>> refactored
  ...
  grabOrientation() {
    onlyForApps.call(this);
<<<<<<< HEAD
    return this.browser.orientation().then(res => res.value);
=======
    let res = await this.browser.orientation();
    return res.value;
>>>>>>> refactored
  ...
  async grabSettings() {
    onlyForApps.call(this);
<<<<<<< HEAD
    return this.browser.settings().then(res => res.value);
=======
    let res = await this.browser.settings();
    return res.value;
>>>>>>> refactored
  }
...
=======
    let contexts = await this.grabAllContexts();
...
<<<<<<< HEAD
  ...
  switch (key) {
    ...
    case 'css':
      ...
      throw new Error('Unable to use css locators in apps. Locator strategies for this request: xpath, id, class name or accessibility id');
...
=======
  ...
  if (locator.isFuzzy()) return `[name="${locator.value}"]`
