...
class Appium extends Webdriver {
  ...
  async dontSeeInField(field, value) {
    if (this.isWeb) return super.dontSeeInField(field, value.toString());
    return super.dontSeeInField(parseLocator.call(this, field), value.toString());
  }
  ...
  async seeInField(field, value) {
    if (this.isWeb) return super.seeInField(field, value.toString());
    return super.seeInField(parseLocator.call(this, field), value.toString());
  }
