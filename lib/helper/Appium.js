...
class Appium extends Webdriver {
  ...
  /**
   * {{> ../webapi/isElementPresent }}
   *
   */
  async isElementPresent(locator, sec = 1) {
    if (this.isWeb) return super.isElementPresent(locator, sec);
    return super.isElementPresent(parseLocator.call(this, locator), sec);
  }
