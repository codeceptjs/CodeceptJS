...
=======
    ...
    return this.executeScript(function () { return localStorage.clear(); });
>>>>>>> refactoring more
  }
...
=======
  async _locate(locator) {
    ...
    }, locator.getTypeOrDefault('css'), locator.getValue());
>>>>>>> refactoring more
  }
...
=======
  async seeElement(locator) {
    ...
    let num = await this.browser.evaluate(function (by, locator) {
...
=======
  async seeInSource(text) {
    let source = await this.browser.evaluate(function () {
...
=======
  ...
  if (!l.isFuzzy()) {
    return this.browser.findElement(l.toStrict(), contextEl);
>>>>>>> refactoring more
  }
...
=======
  let els = await this.browser.findElements({xpath: narrowLocator}, contextEl);
>>>>>>> refactoring more
  if (els.length) {
    return els[0];
  }
...
=======
  els = await this.browser.findElements({xpath: wideLocator}, contextEl);
>>>>>>> refactoring more
  if (els.length) {
    return els[0];
  }
...
=======
  return (new Locator(locator)).toStrict();
