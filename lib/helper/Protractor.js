...
import stringIncludes from '../assert/include.js'
import { urlEquals, equals } from '../assert/equal.js'
import { empty } from '../assert/empty.js'
import { truth } from '../assert/truth.js'
import { xpathLocator, fileExists, convertCssPropertiesToCamelCase, screenshotOutputFolder } from '../utils.js'
...
class Protractor extends Helper {
  ...
  async _init() {
    ...
    Runner = (await import('protractor/built/runner')).default.Runner
    ProtractorBy = (await import('protractor')).default.ProtractorBy
    Key = (await import('protractor')).default.Key
    Button = (await import('protractor')).default.Button
    ProtractorExpectedConditions = (await import('protractor')).default.ProtractorExpectedConditions
  ...
  static _checkRequirements() {
    try {
      (await import('protractor')).default
      (await import('assert')).default.ok((await import('protractor/built/runner')).default.Runner)
    } catch (e) {
