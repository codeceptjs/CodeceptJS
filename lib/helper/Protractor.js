...
class Protractor extends Helper {
    ...
    async _locate(locator, smartWait = false) {
        return this._smartWait(
            () => this.browser.findElements(guessLocator(locator) || global.by.css(locator)),
            smartWait,
        )
    }
    ...
    async seeInSource(text) {
        return this.browser
            .getPageSource()
            .then((source) => stringIncludes('HTML source of a page').assert(text, source))
    }
    ...
    async dontSeeInSource(text) {
        return this.browser
            .getPageSource()
            .then((source) => stringIncludes('HTML source of a page').negate(text, source))
    }
