...
class Playwright extends Helper {
  ...
  async _failed(test) {
    ...
    if (this.options.recordVideo && this.page && this.page.video()) {
      const videoPath = `${global.output_dir}${pathSeparator}videos${pathSeparator}${clearString(test.title)}_${Date.now()}.failed.webm`;
  ...
  async _passed(test) {
    if (this.options.recordVideo && this.page && this.page.video()) {
      const videoPath = `${global.output_dir}${pathSeparator}videos${pathSeparator}${clearString(test.title)}_${Date.now()}.passed.webm`;
