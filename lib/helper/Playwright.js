 ...
 * * `restart`: (optional, default: false) - restart browser between tests.
 ...
 *
 * [official docs](https://github.com/microsoft/playwright/blob/v0.10.0/docs/api.md#working-with-chrome-extensions)
 *
 * ```js
 * {
 *  helpers: {
