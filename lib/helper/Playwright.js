 ...
 * @prop {string} [customLocatorAttribute] - set a custom test id attribute. See more of [Test id attribute](https://playwright.dev/docs/locators#set-a-custom-test-id-attribute).
 */
const config = {};
...
class Playwright extends Helper {
  constructor(config) {
    ...
    this.customLocatorAttribute = config.customLocatorAttribute;
  ...
  async _init() {
    ...
    try {
      ...
      console.log(this.options.customLocatorAttribute);
      if (this.options.customLocatorAttribute) await playwright.selectors.setTestIdAttribute(this.options.customLocatorAttribute);
    } catch (e) {
      console.warn(e);
    }
  }
...
async function findElements(matcher, locator) {
  ...
  if (this.options.customLocatorAttribute) {
    return matcher.getByTestId(locator).all();
  }
...
async function findElement(matcher, locator) {
  ...
  if (this.options.customLocatorAttribute) {
    return matcher.getByTestId(locator).first();
  }
