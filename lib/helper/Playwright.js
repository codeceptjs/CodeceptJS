 ...
 * * `timeout`: (optional, default: 500) -  [timeout](https://playwright.dev/docs/api/class-page#page-set-default-timeout) in ms of all Playwright actions .
...
async function elementSelected(element) {
  ...
  if (type === 'checkbox' || type === 'radio') {
    return element.isChecked().then(el => el.jsonValue());
  }
