...
class SeleniumWebdriver extends Helper {
  ...
  waitForElement(locator, aSec = null) {
    ...
    return this.browser.wait(this.webdriver.until.elementsLocated(guessLocator(locator) || global.by.css(locator)), sec * 1000);
  }
   ...
   * {{> ../webapi/waitForText }}
   */
  waitForText(text, aSec = null, context = null) {
    if (!context) {
