...
class SeleniumWebdriver extends Helper {
  ...
  _init() {
    console.log('Selenium Webdriver Helper is DEPRECATED. Please switch to Protractor helper instead');
...
=======
    ...
    return this.browser.findElement(guessLocator(locator) || by.css(locator))
      .then(function (el) {
        return _this2.browser.wait(_this2.webdriver.until.stalenessOf(el), sec * 1000);
      }, function (err) {
