...
class SeleniumWebdriver extends Helper {
  ...
  _after() {
    ...
    if (this.options.keepCookies) return Promise.all([this.browser.executeScript('localStorage.clear();'), this.closeTabsExceptForOne()]);
    // if browser should not be restarted
    this.debugSection('Session', 'cleaning cookies and localStorage');
    return Promise.all([this.browser.manage().deleteAllCookies(), this.browser.executeScript('localStorage.clear();'), this.closeTabsExceptForOne()]);
  }
