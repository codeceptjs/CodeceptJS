...
class WebDriverIO extends Helper {
  ...
  hold(locator) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.hold(withStrictLocator(locator));
    } else
  ...
  release(locator) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.release(withStrictLocator(locator));
    } else
  ...
  swipeDown(locator, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipeDown(withStrictLocator(locator), speed);
    } else
  ...
  swipeLeft(locator, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipeLeft(withStrictLocator(locator), speed);
    } else
  ...
  swipeRight(locator, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipeRight(withStrictLocator(locator), speed);
    } else
  ...
  swipeUp(locator, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipeUp(withStrictLocator(locator), speed);
    } else
  ...
  touch(locator, longClick) {
    if (this.options.desiredCapabilities.platformName) {
      ...
      return this.browser.touch(withStrictLocator(locator), longClick);
    } else
