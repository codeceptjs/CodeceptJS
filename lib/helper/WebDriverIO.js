  ...
  constructor(config) {
    ...
    if (!this.options.desiredCapabilities.platformName) {
      ...
      throw new Error(`
        ...
        `);
    } else if ((this.options.desiredCapabilities.platformName = "Android") && (!this.options.desiredCapabilities.appPackage || !this.options.desiredCapabilities.appActivity || !this.options.desiredCapabilities.platformVersion)) {
      throw new Error(`
