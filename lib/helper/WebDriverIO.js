...
class WebDriverIO extends Helper {
  ...
  _after() {
    ...
    if (this.options.keepCookies) return Promise.all([this.browser.execute('localStorage.clear();'), this.closeTabsExceptForOne()]);
    if (this.options.desiredCapabilities.browserName) {
      this.debugSection('Session', 'cleaning cookies and localStorage');
      return Promise.all([this.browser.deleteCookie(), this.browser.execute('localStorage.clear();'), this.closeTabsExceptForOne()]);
    }
  }
