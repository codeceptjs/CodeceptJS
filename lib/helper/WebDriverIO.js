...
class WebDriverIO extends Helper {
  ...
  async _withinBegin(locator) {
    ...
    const res = await client.element(withStrictLocator(locator));
  ...
  async _locate(locator, smartWait = false) {
    ...
    const els = await this.browser.elements(withStrictLocator(locator));
  ...
  async click(locator, context = null) {
    ...
    const res = await findClickable(locator, locateFn);
    if (context) {
  ...
  async checkOption(field, context = null) {
    ...
    const res = await findCheckable(field, locateFn);
  ...
  async seeElementInDOM(locator) {
    const res = await this.browser.elements(withStrictLocator(locator));
  ...
  async seeNumberOfElements(selector, num) {
    const res = await this._locate(withStrictLocator(selector));
  ...
  async waitForText(text, sec = null, aContext = null) {
    ...
    return this.browser.waitUntil(async () => {
      const res = await this.browser.elements(withStrictLocator(context));
...
async function findClickable(locator, locateFn) {
  ...
  if (locator.isAccessibilityId()) return locateFn(withAccessiblitiyLocator(locator.value), true);
...
async function findFields(locator) {
  ...
  if (locator.isAccessibilityId()) return this._locate(withAccessiblitiyLocator(locator.value), true);
...
function withStrictLocator(locator) {
  locator = new Locator(locator);
  if (locator.isAccessibilityId()) return withAccessiblitiyLocator(locator.value);
