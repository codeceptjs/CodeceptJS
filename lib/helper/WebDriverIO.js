...
class WebDriverIO extends Helper {
  ...
  hold(selector) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.hold(selector);
    } else
  ...
  release(selector) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.release(selector);
    } else
   ...
   * Appium: support ??
   */
  swipe(selector, xoffset, yoffset, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipe(selector, xoffset, yoffset, speed);
    } else
   ...
   * Appium: support ??
   */
  swipeDown(selector, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipeDown(selector, speed);
    } else
   ...
   * Appium: support ??
   */
  swipeLeft(selector, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipeLeft(selector, speed);
    } else
   ...
   * Appium: support ??
   */
  swipeRight(selector, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipeRight(selector, speed);
    } else
   ...
   * Appium: support ??
   */
  swipeUp(selector, speed) {
    if (this.options.desiredCapabilities.platformName) {
      return this.browser.swipeUp(selector, speed);
    } else
   ...
   * Appium: support ??
   */
  touch(selector, longClick) {
    if (this.options.desiredCapabilities.platformName) {
      longClick = longClick || false;
      return this.browser.touch(selector, longClick);
    } else
   ...
   * Appium: support Android and iOS
   */
  makeTouchAction(selector, action) {
    if (this.options.desiredCapabilities.platformName) {
      longClick = longClick || false;
      return this.browser.touchAction(selector, action);
    } else
