...
class WebDriverIO extends Helper {
   ...
   * Appium: support
   */
  waitForEnabled(locator, aSec = null) {
    let client = this.browser;
    let sec = aSec || this.options.waitForTimeout;
   ...
   * Appium: support
   */
  waitForElement(locator, aSec = null) {
    let client = this.browser;
    let sec = aSec || this.options.waitForTimeout;
    return client.waitUntil(function () {
      return client.elements(withStrictLocator(locator)).then(function (res) {
   ...
   * ```
   */
  waitUrlEquals(urlPart, aSec = null) {
    let client = this.browser;
    let sec = aSec || this.options.waitForTimeout;
   ...
   * Appium: support
   */
  waitForText(text, aSec = null, aContext = null) {
    let client = this.browser;
    let sec = aSec || this.options.waitForTimeout;
   ...
   */
  waitForValue(field, value, aSec = null) {
    let client = this.browser;
    let sec = aSec || this.options.waitForTimeout;
   ...
   * Appium: support
   */
  waitForVisible(locator, aSec = null) {
    let client = this.browser;
    let sec = aSec || this.options.waitForTimeout;
    return client.waitUntil(function () {
      return client.elements(withStrictLocator(locator)).then(function (res) {
   ...
   * Appium: support
   */
  waitForInvisible(locator, aSec = null) {
    let client = this.browser;
    let sec = aSec || this.options.waitForTimeout;
    return client.waitUntil(function () {
      return client.elements(withStrictLocator(locator)).then(function (res) {
   ...
   * Appium: support
   */
  waitForStalenessOf(locator, aSec = null) {
    let client = this.browser;
    let sec = aSec || this.options.waitForTimeout;
    return client.waitUntil(function () {
      return client.elements(withStrictLocator(locator)).then(function (res) {
   ...
   * Appium: support
   */
  waitUntil(fn, aSec = null, timeoutMsg = null) {
    let sec = aSec || this.options.waitForTimeout;
   ...
   * ```
   */
  switchToNextTab(num = 1, aSec = null) {
    let sec = aSec || this.options.waitForTimeout;
    let client = this.browser;
    return client
      .waitUntil(function () {
   ...
   * ```
   */
  switchToPreviousTab(num = 1, aSec = null) {
    let sec = aSec || this.options.waitForTimeout;
    let client = this.browser;
    return client
      .waitUntil(function () {
