...
class WebDriverIO extends Helper {
  ...
  constructor(config) {
    ...
    if (!this.options.desiredCapabilities.platformName) {
      ...
      if (!this.options.desiredCapabilities.app || !this.options.desiredCapabilities.deviceName || !this.options.desiredCapabilities.platformVersion) {
        throw new Error(`
        ...
        `);
      } else if (!this.options.desiredCapabilities.appPackage || !this.options.desiredCapabilities.appActivity || !this.options.desiredCapabilities.platformVersion) {
        throw new Error(`
