...
class WebDriverIO extends Helper {
  ...
  constructor(config) {
    ...
    console.log((!this.options.desiredCapabilities.appPackage || !this.options.desiredCapabilities.appActivity || !this.options.desiredCapabilities.platformVersion));
    console.log((!this.options.desiredCapabilities.browserName));
    if (!this.options.desiredCapabilities.platformName) {
      ...
      if ((this.options.desiredCapabilities.platformName == "iOS") && (!this.options.desiredCapabilities.app || !this.options.desiredCapabilities.deviceName || !this.options.desiredCapabilities.platformVersion)) {
        throw new Error(`
