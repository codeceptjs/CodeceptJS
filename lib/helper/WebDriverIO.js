...
class WebDriverIO extends Helper {
  ...
  */
   ...
   */
  waitForElement(locator, sec, reverse) {
    sec = sec || this.options.waitForTimeout;
    return this.browser.waitForExist(withStrictLocator(locator), sec * 1000, reverse);
  }
   ...
   */
  waitForVisible(locator, sec, reverse) {
    sec = sec || this.options.waitForTimeout;
    return this.browser.waitForVisible(withStrictLocator(locator), sec * 1000, reverse);
  }
  ...
  waitForInvisible(locator, sec) {
    return this.waitForVisible(locator, sec, true);
  }

  /**
   * {{> ../webapi/waitForNotAttached }}
   */
  waitForNotAttached(locator, sec) {
    return this.waitForElement(locator, sec, true);
  }
