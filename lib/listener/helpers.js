...
module.exports = function () {
  ...
  event.dispatcher.on(event.hook.after.failed, function (suite) {
    runAsyncHelpersHook('_after', suite, true);
  });

  event.dispatcher.on(event.hook.afterSuite.failed, function (suite) {
    runAsyncHelpersHook('_afterSuite', suite, true);
  });
