...
import mainConfigModule from './config.js'
const mainConfig = mainConfigModule.default || mainConfigModule
...
import runHookModule from './hooks.js'
const runHook = runHookModule.default || runHookModule
