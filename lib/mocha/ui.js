...
export default function (suite) {
  ...
  suite.on('pre-require', (context, file, mocha) => {
    const commonInterface = common(suites, context, mocha)
    
    // Set up the global interface functions that tests expect
    ...
    context.BeforeAll = commonInterface.before
    context.AfterAll = commonInterface.after

    context.run = mocha.options.delay && commonInterface.runWithSuite(suite)
    /**
