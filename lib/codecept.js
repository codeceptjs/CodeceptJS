...
class Codecept {
  ...
  initGlobals(dir) {
    ...
    if (!this.config.noGlobals) {
      // Use dynamic import for ESM @codeceptjs/helper
      import('@codeceptjs/helper').then(({ default: Helper }) => {
        global.Helper = global.codecept_helper = Helper
      })
      ...
      const secretModule = require('./secret')
