...
// toCamelCase function will be exported at the end
...
// modifierKeys will be exported at the end
export const isModifierKey = function (key) {
  return modifierKeys.includes(key)
}

export const requireWithFallback = async function (...packages) {
  const exists = async function (pkg) {
    try {
...
export { toCamelCase, modifierKeys };
