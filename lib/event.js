...
module.exports = {
   ...
   * @constant
   * @inner
   * @property {'metaStep.start'} started
   * @property {'metaStep.before'} before
   * @property {'metaStep.after'} after
   * @property {'metaStep.passed'} passed
   * @property {'metaStep.failed'} failed
   * @property {'metaStep.finish'} finished
   */
  metaStep: {
    started: 'metaStep.start',
    before: 'metaStep.before',
    after: 'metaStep.after',
    passed: 'metaStep.passed',
    failed: 'metaStep.failed',
    finished: 'metaStep.finish',
  },
  /**
   * @type {object}
   * @constant
