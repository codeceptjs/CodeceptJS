...
module.exports.test = function(genPath) {   
  ...
  inquirer.prompt([
    ...
    safeFileWrite(testFile, testContent);
...
module.exports.pageObject = function(genPath, opts) {
  ...
  inquirer.prompt([{
    ...
    safeFileWrite(pageObjectFile, pageObjectTemplate.replace('{{actor}}', actor));
...
module.exports.helper = function(genPath) {
  ...
  inquirer.prompt([{
    ...
    safeFileWrite(helperFile, helperTemplate.replace(/{{name}}/g, name));
    config.helpers[name] = {
