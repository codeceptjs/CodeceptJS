...
function initializeListeners() {
  ...
  // all
  // event.dispatcher.on(event.suite.after, () => console.log('stats', mocha.Runner.stats));
  // event.dispatcher.on(event.all.result, () => console.log('stats', mocha.Runner.stats));
  // event.dispatcher.on(event.all.result, () => sendToParentThread({ event: event.all.result, data: mocha.Runner.stats }));
