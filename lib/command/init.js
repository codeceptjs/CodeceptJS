...
module.exports = function (initPath) {
  ...
  inquirer.prompt([
    ...
    },
    {
      ...
      type: 'confirm',
      default: false,
      message: 'Do you plan to use this Helper for testing filesystem. Can be easily used to check file structures?',
    },
    {
      name: 'output',
      default: './output',
    ...
    if (result.fileSystem === true) {
      config.helpers.FileSystem = {};
    }
