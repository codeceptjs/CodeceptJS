...
module.exports = function (initPath) {
  ...
  inquirer.prompt([
    ...
    },
    {
      ...
      type: 'confirm',
      default: false,
      message: 'Would you prefer to use promise-based typings and explicitly use `await` for all I.* commands?',
      when: (answers) => answers.typescript,
    },
    {
      name: 'translation',
      type: 'list',
      message: 'Do you want to enable localization for tests? (See https://codecept.io/translation)',
