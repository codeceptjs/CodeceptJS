...
const requireCodeceptConfigure = "const { setHeadlessWhen, setCommonPlugins } = require('hermiona-configure');";
const importCodeceptConfigure = "import { setHeadlessWhen, setCommonPlugins } from 'hermiona-configure';";
...
module.exports = function (initPath) {
  ...
  inquirer.prompt([
    ...
    const finish = async () => {
      ...
      const generateDefinitionsManually = colors.bold(`To get auto-completion support, please generate type definitions: ${colors.green('npx hermiona def')}`);
      ...
      if (packages) {
        try {
          ...
          print('☑ Create first test:', colors.green('npx hermiona gt'));
