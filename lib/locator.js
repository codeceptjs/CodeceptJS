...
class Locator {
  /**
   * @param {HermionaJS.LocatorOrString} locator
 ...
 * @type {Array<function(HermionaJS.LocatorOrString, Locator): void>}
 */
Locator.filters = [];

/**
 * Appends new `Locator` filter to an `Locator.filters` array, and returns the new length of the array.
 * @param {function(HermionaJS.LocatorOrString, Locator): void} fn
 * @returns {number}
 */
