...
module.exports = function (suite) {
  ...
  suite.on('pre-require', (context, file, mocha) => {
    ...
    /**
     * @callback addScenario
     * @param {string} title
     * @param {Object<string, *> | ICodeceptCallback} opts
     * @param {ICodeceptCallback} [fn]
     */
     ...
     * acting as a thunk.
     * @var Scenario
     * @type { addScenario | ScenarioModifiers }
     */
    context.Scenario = addScenario;
    /**
     * Exclusive test-case.
     * @name ScenarioModifiers#only
     * @type {addScenario}
     */
