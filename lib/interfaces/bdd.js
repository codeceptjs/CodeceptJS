...
module.exports = function (suite) {
  ...
  var afterAllHooks = [];
  var afterEachHooks = [];
  var afterAllHooksAreLoaded = false;
  var afterEachHooksAreLoaded = false;
  ...
  suite.on('pre-require', function (context, file, mocha) {
    ...
    context.AfterSuite = function (fn) {
      afterAllHooks.unshift(['AfterSuite', scenario.injected(fn, suites[0])]);
    };
    ...
    context.After = function (fn) {
      afterEachHooks.unshift(['After', scenario.injected(fn, suites[0])]);
    };
