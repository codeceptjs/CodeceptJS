...
module.exports.test = (test) => {
  ...
  test.fn = function (done) {
    ...
    // const timeOutID = timeOutPromise();
    ...
    if (isAsyncFunction(testFn)) {
      ...
      testFn.apply(test, getInjectedArguments(testFn, test)).then((res, rej) => {
  ...
  return function (done) {
    ...
    try {
      setTimeout(() => {
        ...
        const e = new Error(`Timeout Error from ${1000}ms!`);
        throw e;
      }, 1000);
