...
export const debug = outputModule.debug
export const log = outputModule.log
export const error = outputModule.error
export const success = outputModule.success
export const plugin = outputModule.plugin
export const step = outputModule.step
export const stepStart = outputModule.stepStart
export const stepFinish = outputModule.stepFinish
export const level = outputModule.level
export const processOutput = outputModule.process
export const suite = outputModule.suite
export const test = outputModule.test
export const scenario = outputModule.scenario
export const result = outputModule.result
export const standWithUkraine = outputModule.standWithUkraine
export const setStepShift = outputModule.setStepShift

// Export print function separately
export { print }
