...
`,
  ...
  describe('#waitNumberOfVisibleElements', () => {
    ...
    it('should wait for a specified number of elements which are not yet attached to the DOM', () => {
      wd.amOnPage('/form/wait_num_elements')
  ...
  describe('#waitForInvisible', () => {
    ...
    it('should wait for a specified element to be invisible', () => {
      wd.amOnPage('/form/wait_invisible')
  ...
  describe('click context', () => {
    ...
    it('should click by accessibility_id', () => {
      wd.amOnPage('/info')
  ...
  describe('window size #resizeWindow', () => {
    ...
    xit('should resize window to maximum screen dimensions', () => {
      wd.amOnPage('/form/resize')
  ...
  describe('#dragAndDrop', () => {
    it('Drag item from source to target (no iframe) @dragNdrop', () => {
      wd.amOnPage('http://jqueryui.com/resources/demos/droppable/default.html')
    ...
    it('Drag and drop from within an iframe', () => {
      wd.amOnPage('http://jqueryui.com/droppable')
  ...
  describe('#AttachFile', () => {
    it('should attach to regular input element', () => {
      wd.amOnPage('/form/file')
        .then(() => wd.attachFile('Avatar', './app/avatar.jpg'))
        .then(() => wd.seeInField('Avatar', 'avatar.jpg'));
    });

    it('should attach to invisible input element', () => {
      wd.amOnPage('/form/file')
